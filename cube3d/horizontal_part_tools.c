...
/*   Updated: 2025/11/05 16:50:53 by amaliari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	find_horizontal_wall_hit(t_hori *hori, t_step steps, t_game *cub,  int strip_id)
{
	...
	// printf("%d------%d\n", cub->game_info->num_cols, cub->game_info->num_rows);
	while (hori->next_hori_touch_x >= 0 && hori->next_hori_touch_x < cub->game_info->num_cols * TILE_SIZE
        && hori->next_hori_touch_y >= 0 && hori->next_hori_touch_y < cub->game_info->num_rows * TILE_SIZE
		)
    {
