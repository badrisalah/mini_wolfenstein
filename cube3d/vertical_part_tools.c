...
/*   Updated: 2025/11/05 23:50:40 by amaliari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	find_vertical_wall_hit(t_vert *vert, t_step steps, t_game *cub, int strip_id)
{
    ...
    int     grid_x;
    int     grid_y;
	while (vert->next_vert_touch_x >= 0 && vert->next_vert_touch_x < cub->game_info->num_cols * TILE_SIZE
        && vert->next_vert_touch_y >= 0 && vert->next_vert_touch_y < cub->game_info->num_rows * TILE_SIZE)
    {
