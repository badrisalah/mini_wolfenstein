...
/*   Updated: 2025/10/30 13:39:35 by amaliari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    float diff = hori.hori_hit_distance - vert.vert_hit_distance;
    
    if (fabs(diff) < EPSILON)
    {
        // They're essentially equal, prefer horizontal
